...
_io = [
 ...
 ("synthio_bus", 0,
     ...
     Subsignal("dat_r",   Pins("SYN108 SYN109 SYN110 SYN111 SYN112 SYN113 SYN114 SYN115 SYN116 SYN117 SYN118 SYN119 SYN120 SYN121 SYN122 SYN123 SYN124 SYN125 SYN126 SYN127 SYN128 SYN129 SYN130 SYN131 SYN132 SYN133 SYN134 SYN135 SYN136 SYN137 SYN138 SYN139 ")),
     Subsignal("sel",   Pins("SYN64 SYN65 SYN66 SYN67 ")),
     Subsignal("cyc",   Pins("SYN68 ")),
     Subsignal("stb",   Pins("SYN69 ")),
     Subsignal("ack",   Pins("SYN140 ")),
     Subsignal("we",   Pins("SYN70 ")),
     Subsignal("cti",   Pins("SYN71 SYN72 SYN73 ")),
     Subsignal("bte",   Pins("SYN74 SYN75 ")),
     Subsignal("err",   Pins("SYN141 ")),
 ),
 ("synthio_in", 0,
     Subsignal("in0",   Pins("SYN76 ")),
     Subsignal("in1",   Pins("SYN77 SYN78 ")),
     Subsignal("in2",   Pins("SYN79 SYN80 SYN81 ")),
     Subsignal("in3",   Pins("SYN82 SYN83 SYN84 SYN85 ")),
     Subsignal("in4",   Pins("SYN86 SYN87 SYN88 SYN89 SYN90 ")),
 ),
 ("synthio_out", 0,
     Subsignal("out0",   Pins("SYN142 ")),
     Subsignal("out1",   Pins("SYN143 SYN144 ")),
     Subsignal("out2",   Pins("SYN145 SYN146 SYN147 ")),
     Subsignal("out3",   Pins("SYN148 SYN149 SYN150 SYN151 ")),
     Subsignal("out4",   Pins("SYN152 SYN153 SYN154 SYN155 SYN156 ")),
 ),
]
