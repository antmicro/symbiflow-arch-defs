...
_io = [
 ...
 ("synthio_in", 0,
     ...
     Subsignal("in4",   Pins("SYN86 SYN87 SYN88 SYN89 ")),
 ),
 ("synthio_out", 0,
     Subsignal("out0",   Pins("SYN124 ")),
     Subsignal("out1",   Pins("SYN125 SYN126 ")),
     Subsignal("out2",   Pins("SYN127 SYN128 SYN129 ")),
     Subsignal("out3",   Pins("SYN130 SYN131 SYN132 SYN133 ")),
     Subsignal("out4",   Pins("SYN134 SYN135 SYN136 SYN137 ")),
 ),
