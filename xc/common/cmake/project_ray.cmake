...
function(PROJECT_RAY_PREPARE_DATABASE)
  set(options)
  set(oneValueArgs FAMILY PRJRAY_ARCH PRJRAY_DIR PRJRAY_DB_DIR PRJRAY_NAME PROTOTYPE_PART GRAPH_LIMIT)
  ...
  if(NOT "${PROJECT_RAY_PREPARE_DATABASE_GRAPH_LIMIT}" STREQUAL "")
    set(FORM_CHANNELS_ARGS --grid_limit ${PROJECT_RAY_PREPARE_DATABASE_GRAPH_LIMIT})
  endif()
