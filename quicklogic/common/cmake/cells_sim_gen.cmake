FUNCTION(ADD_CELLS_SIM_TARGET OUTPUT_FILE FAMILY_NAME)
  ...
  get_target_property(VERILOG_SOURCES QL_${FAMILY_NAME}_CELLS_SIM_DEPS VERILOG_SOURCES)
  ...
  add_custom_command(
    OUTPUT ${OUTPUT_FILE}
    DEPENDS ${PYTHON3} ${PYTHON3_TARGET} ${CONCATENATE_V_SOURCES_PY} QL_${FAMILY_NAME}_CELLS_SIM_DEPS
