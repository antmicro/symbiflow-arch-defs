  ...
  if (${LITEX_BOARD})
    add_custom_command(
      ...
      COMMAND
        ...
        ${PYTHON3} ${GENERATE_SCRIPT} --board ${LITEX_BOARD} --output_dir ${LITEX_DIR} --integrated-rom-size 0x10000 --uart-baudrate 1000000 ${FLAGS}
      COMMAND
    ...
    add_custom_command(
      ...
      COMMAND
        ${CMAKE_COMMAND} -E env PYTHON=${PYTHON3}
        ${PYTHON3} ${GENERATE_SCRIPT} --output_dir ${LITEX_DIR} ${FLAGS}
      COMMAND
        ${PYTHON3} ${FIXUP_SCRIPT} --xdc ${LITEX_GATEWARE}/${TOP}.xdc
    )
  endif()
